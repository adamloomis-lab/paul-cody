...
// the production team. Transcribed from the original /bio page. Portraits come
// from the Duda site's member photos (mountain-sunset background set); Aimee
// Lennox and Tony Nicholas have no photo on the source site.
